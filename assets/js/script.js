...
function cachipun(){
    ...
    var numJugadas;
    do {
        numJugadas=prompt("Ingrese el número de jugadas [debe ser un número impar]: ")
        numJugadas=parseInt(numJugadas)
        if (numJugadas%2!=1) {
            alert("Por favor, ingrese un número impar.")
        }
    } while (numJugadas%2!=1);
    ...
    for (let i = 0; i < numJugadas; i++) {
        ...
        var optJugador=0;
        /* Código usado antes de implementar Click
        do {
        ...
        while (optJugador==0) {
            console.log("Esperando a que Jugador seleccione su opción...")
        }
